...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o book.o clothing.o movie.o bdatastore.o
...
bdatastore.o: bdatastore.cpp bdatastore.h product_parser.h movie.h book.h clothing.h util.h 
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c bdatastore.cpp
